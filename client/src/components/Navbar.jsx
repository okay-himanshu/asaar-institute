    ...
    <Wrapper className="flex items-start justify-between">
      <nav className="flex flex-col w-full justify-between items-start py-5  w-850:flex-row w-850:items-center">
        ...
        <div
          className={`${
            toggle ? "block" : "hidden"
          } w-850:flex w-850:flex-row w-full w-850:w-fit flex-col gap-4 items-start  uppercase text-sm mt-2 relative`}
        >
                ...
                <div className="w-850:absolute top-12  capitalize">
                  {route.children.map((child, childIndex) => (
                    <NavLink
                      ...
                      className={"w-full"}
                    >
                      <div className=" w-full z-10 divide-y divide-gray-100 rounded-md border border-gray-100 bg-white shadow-md w-850:shadow-lg">
